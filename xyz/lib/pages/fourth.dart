...
class _FourthPageState extends State<FourthPage> {
  ...
  Future<String> _getChatGptResponse(String prompt) async {
    const String apiKey =
        "2jubX6kMzzdjr8vpidh8tyuD4lAf6CjRwrrqMuhI7HxiiFv61eKyJQQJ99ALACYeBjFXJ3w3AAABACOGFlCt";
    const String endpoint =
        "https://cropai.openai.azure.com/openai/deployments/gpt-4o/chat/completions?api-version=2024-08-01-preview";
      ...
      "messages": [
        {
          "role": "system",
          "content":
              "You are an agricultural expert providing detailed and actionable advice."
        },
  ...
  Future<void> _fetchDetailedTreatmentInfo(String diseaseName) async {
    String prompt =
        "Provide detailed treatment options for managing $diseaseName in crops.";
    try {
      setState(() {
        _messages.add({
          "type": "user",
          "text": "Fetching detailed info for $diseaseName..."
        });
      });
      ...
      setState(() {
        _messages.add({
          "type": "bot",
          "text": "Error occurred while fetching detailed info."
        });
      });
    }
  }
